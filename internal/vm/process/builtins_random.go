...
func bi_random(pr *Process, args ...object.Object) object.Object {
	const fnName = "random"
	...
	case *object.List:
		...
		e, err := randomInteger(0, int64(len(n.Elements)))
		if err != nil {
	...
	case *object.String:
		...
		arg, err := randomInteger(0, int64(len(codePoints)))
		if err != nil {
			return object.NewError(object.ERR_GENERAL, fnName, err.Error())
		}
	...
	case *object.Hash:
		...
		e, err := randomInteger(0, int64(len(values)))
		if err != nil {
			return object.NewError(object.ERR_GENERAL, fnName, err.Error())
		}
		return values[e]
	...
	result, err := randomInteger(start, end+1)
	if err != nil {
		return object.NewError(object.ERR_GENERAL, fnName, err.Error())
	}
...
func randomInteger(start, endExclusive int64) (int64, error) {
	// using crypto/rand
	resultBig, err := crand.Int(crand.Reader, big.NewInt(endExclusive-start))
	if err != nil {
		return 0, err
	}
