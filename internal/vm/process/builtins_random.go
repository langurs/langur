	...
	Fn: func(pr *Process, args ...object.Object) object.Object {
		...
		case *object.Range:
			...
			case *object.Number:
				start, err = e.ToInt64()
				if err != nil {
					return object.NewException(object.ERR_ARGUMENTS, fnName, "Integer range failure")
				}
			default:
				return object.NewException(object.ERR_ARGUMENTS, fnName, "Integer range failure")
			}
		...
		case *object.String:
			...
			if len(codePoints) == 0 {
				return object.NewException(object.ERR_ARGUMENTS, fnName, "Expected non-zero-length string")
			}
		...
		case *object.Hash:
			...
			if len(n.Pairs) == 0 {
				return object.NewException(object.ERR_ARGUMENTS, fnName, "Expected non-empty hash")
			}
		...
		default:
			return object.NewException(object.ERR_ARGUMENTS, fnName, "Expected integer or integer range argument, or non-empty list, hash, or string")
		}
